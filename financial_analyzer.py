...
def main():
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            file_path = None # IMPORTANT: Set file_path to None on error to prevent downstream issues
    ...
    if company_name:
        ...
        if st.button("Analyze Financial Data"):
            ...
            if file_path and os.path.exists(file_path): # Check if the file exists before attempting to remove it
